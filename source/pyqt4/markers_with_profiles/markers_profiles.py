...
version 0.6 - multiple settings file capability - first argument ot the script
...
class MarkerControl(QMainWindow):
    ...
    def __init__(self, app, ini_file=None, parent=None):
        ...
        if ini_file is not None and (isinstance(ini_file, str) or isinstance(ini_file, unicode)):
...
def usage():
    ...
    :return:
    """
    print "Usage:\npython %s profile_name\n\tprofile_name - filename containing settings" % __file__
